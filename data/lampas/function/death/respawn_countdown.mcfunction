...
execute as @a[tag=dead] at @s if score @s deathCounter matches 1 run scoreboard players set @s respawnCountdown 150
...
execute as @a[tag=respawnPending] at @s if score @s deathCounter matches 0 if score @s respawnCountdown matches 1..150 run scoreboard players remove @s respawnCountdown 1
